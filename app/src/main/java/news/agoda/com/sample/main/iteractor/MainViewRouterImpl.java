 ...
 */
public class MainViewRouterImpl {

    public MainViewRouterImpl() {
    }
    ...
    public void onListItemClick(@NonNull final Activity activity, @NonNull final NewsEntity newsEntity) {
